...
@Component({
  selector: 'app-addquiz3',
  templateUrl: './addquiz3.component.html',
  styleUrls: ['./addquiz3.component.css']
})
export class Addquiz3Component implements OnInit {
  addquiz:FormGroup;
  resData;
  resObj;
  fetch;
  ...
  addqu(){
    ...
    this.resObj=this.oper.addquiz3(seriliz).subscribe((res)=>{
      this.resData=res;
      ...
      fetchData(){
        this.formData=this.oper.fetchAll3().subscribe((res)=>{
          this.formObj=res;
