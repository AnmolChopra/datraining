...
@Component({
  selector: 'app-addquiz4',
  templateUrl: './addquiz4.component.html',
  styleUrls: ['./addquiz4.component.css']
})
export class Addquiz4Component implements OnInit {
  addquiz:FormGroup;
  resData;
  resObj;
  fetch;
  ...
  addqu(){
    ...
    this.resObj=this.oper.addquiz4(seriliz).subscribe((res)=>{
      this.resData=res;
      ...
      fetchData(){
        this.formData=this.oper.fetchAll4().subscribe((res)=>{
          this.formObj=res;
