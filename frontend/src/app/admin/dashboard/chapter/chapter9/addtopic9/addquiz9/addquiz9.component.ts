...
@Component({
  selector: 'app-addquiz9',
  templateUrl: './addquiz9.component.html',
  styleUrls: ['./addquiz9.component.css']
})
export class Addquiz9Component implements OnInit {
  addquiz:FormGroup;
  resData;
  resObj;
  fetch;
  ...
  addqu(){
    ...
    this.resObj=this.oper.addquiz9(seriliz).subscribe((res)=>{
      this.resData=res;
      ...
      fetchData(){
        this.formData=this.oper.fetchAll9().subscribe((res)=>{
          this.formObj=res;
