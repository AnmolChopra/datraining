...
@Component({
  selector: 'app-addquiz8',
  templateUrl: './addquiz8.component.html',
  styleUrls: ['./addquiz8.component.css']
})
export class Addquiz8Component implements OnInit {
  addquiz:FormGroup;
  resData;
  resObj;
  fetch;
  ...
  addqu(){
    ...
    this.resObj=this.oper.addquiz8(seriliz).subscribe((res)=>{
      this.resData=res;
      ...
      fetchData(){
        this.formData=this.oper.fetchAll8().subscribe((res)=>{
          this.formObj=res;
