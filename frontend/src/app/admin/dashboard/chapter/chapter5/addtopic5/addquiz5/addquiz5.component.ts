...
@Component({
  selector: 'app-addquiz5',
  templateUrl: './addquiz5.component.html',
  styleUrls: ['./addquiz5.component.css']
})
export class Addquiz5Component implements OnInit {
  addquiz:FormGroup;
  resData;
  resObj;
  fetch;
  ...
  addqu(){
    ...
    this.resObj=this.oper.addquiz5(seriliz).subscribe((res)=>{
      this.resData=res;
      ...
      fetchData(){
        this.formData=this.oper.fetchAll5().subscribe((res)=>{
          this.formObj=res;
